        ...
        <CardContent className="px-6 pb-6 space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-2">
              ...
              <Input id="api-url" defaultValue="https://api.esgenius.io/v1" />
        ...
        <CardContent className="px-6 pb-6 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-2">
              ...
              <Input id="smtp-sender" type="email" defaultValue="noreply@esgenius.io" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="smtp-name" className="text-sm font-medium">
                Sender Name
              </Label>
              <Input id="smtp-name" defaultValue="ESGenius Platform" />
            </div>
          </div>
          <div className="flex justify-end pt-2">
            <Button className="font-semibold">
