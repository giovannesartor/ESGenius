              ...
              <div className="relative" style={{ animation: "slideIn 0.8s ease-out 0.3s both" }}>
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/50">
                  ...
                  <div className="flex items-center justify-between mb-8 px-4">
                    <ScoreRing label={t("home.environmental")} score={87} color="#16a34a" delay="0.3s" />
                    <ScoreRing label={t("home.social")} score={72} color="#2563eb" delay="0.6s" />
                    <ScoreRing label={t("home.governance")} score={91} color="#f59e0b" delay="0.9s" />
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      { label: t("home.indicators"), value: "147/156", icon: <BarChart3 className="h-3.5 w-3.5" /> },
                      { label: t("home.compliance"), value: "94%", icon: <CheckCircle2 className="h-3.5 w-3.5" /> },
